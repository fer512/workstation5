...
import { EntityArrayResponseType, WorkerService } from '../service/worker.service';
...
export class WorkerComponent implements OnInit {
  ...
  trackId = (_index: number, item: IWorker): number => this.workerService.getWorkerIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IWorker[] | null): IWorker[] {
    return data ?? [];
  }
