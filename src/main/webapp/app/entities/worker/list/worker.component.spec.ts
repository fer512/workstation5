...
describe('Worker Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'worker', component: WorkerComponent }]), HttpClientTestingModule, WorkerComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to workerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getWorkerIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getWorkerIdentifier).toHaveBeenCalledWith(entity);
